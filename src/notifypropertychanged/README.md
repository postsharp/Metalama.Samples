...
The `BuildAspect` method first calls <xref:Metalama.Framework.Aspects.AdviserExtensions.ImplementInterface*> to add
...
interface. The <xref:Metalama.Framework.Aspects.AdviserExtensions.ImplementInterface*> method requires the interface
...
a setter. It does this by calling the <xref:Metalama.Framework.Aspects.AdviserExtensions.OverrideAccessors*>
