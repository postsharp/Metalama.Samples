...
internal class MainViewModel : ObservableRecipient
{
    ...
    private IMemento _beforeEditingMemento;
    ...
    {
        this.IsEditing = true;
        this._beforeEditingMemento = this.CurrentItem!.Save();
    }
    ...
    private void ExecuteSave()
    {
        ...
        this._beforeEditingMemento = null;
    }
    ...
    {
        this.IsEditing = false;
        this.CurrentItem!.Restore( this._beforeEditingMemento );
    }
