...
public partial class GenerateBuilderAttribute : TypeAspect
{
    ...
    private void BuilderConstructorTemplate()
    {
        ...
        {
            property.SetBuilderPropertyValue( meta.Target.Parameters[property.BuilderConstructorParameterIndex!.Value], ExpressionFactory.This() );
        }
    }
    ...
    private void BuilderCopyConstructorTemplate( dynamic source )
    {
        ...
        foreach ( var property in tags.Properties.Where( p => !p.IsInherited ) )
        {
            property.SetBuilderPropertyValue( property.SourceProperty.With( (IExpression) source ), ExpressionFactory.This());
        }
    }
}