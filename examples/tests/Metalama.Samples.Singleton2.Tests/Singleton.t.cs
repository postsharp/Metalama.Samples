// Warning LAMA0905 on `new ConfigurationManager(configurationSource)`: `The 'ConfigurationManager' type cannot be referenced by the 'ProductionClass' type. The class is a [Singleton].`
