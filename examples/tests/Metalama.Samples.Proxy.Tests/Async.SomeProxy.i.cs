...
namespace Metalama.Samples.Proxy.Tests
{
  public class SomeProxy : ISomeInterface
  {
    ...
    static SomeProxy()
    {
      _metadata1 = new InterceptionMetadata(typeof(ISomeInterface).GetMethod("TaskMethodAsync", BindingFlags.Public | BindingFlags.Instance, null, new[] { typeof(int), typeof(string) }, null) ?? throw new MissingMethodException("The method 'ISomeInterface.TaskMethodAsync(int, string)' could not be found using reflection."), true);
      _metadata2 = new InterceptionMetadata(typeof(ISomeInterface).GetMethod("TaskOfIntMethodAsync", BindingFlags.Public | BindingFlags.Instance, null, new[] { typeof(int), typeof(string) }, null) ?? throw new MissingMethodException("The method 'ISomeInterface.TaskOfIntMethodAsync(int, string)' could not be found using reflection."), true);
      _metadata3 = new InterceptionMetadata(typeof(ISomeInterface).GetMethod("ValueTaskMethodAsync", BindingFlags.Public | BindingFlags.Instance, null, new[] { typeof(int), typeof(string) }, null) ?? throw new MissingMethodException("The method 'ISomeInterface.ValueTaskMethodAsync(int, string)' could not be found using reflection."), true);
      _metadata4 = new InterceptionMetadata(typeof(ISomeInterface).GetMethod("ValueTaskOfIntMethodAsync", BindingFlags.Public | BindingFlags.Instance, null, new[] { typeof(int), typeof(string) }, null) ?? throw new MissingMethodException("The method 'ISomeInterface.ValueTaskOfIntMethodAsync(int, string)' could not be found using reflection."), true);
    }
