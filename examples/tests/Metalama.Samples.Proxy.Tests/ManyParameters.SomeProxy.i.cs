...
namespace Metalama.Samples.Proxy.Tests
{
  public class SomeProxy : ISomeInterface
  {
    ...
    static SomeProxy()
    {
      _metadata1 = new InterceptionMetadata(typeof(ISomeInterface).GetMethod("Void10Params", BindingFlags.Public | BindingFlags.Instance, null, new[] { typeof(int), typeof(string), typeof(long), typeof(DateOnly), typeof(TimeSpan), typeof(Guid), typeof(short), typeof(int? ), typeof(TimeZoneInfo), typeof(object) }, null) ?? throw new MissingMethodException("The method 'ISomeInterface.Void10Params(int, string, long, DateOnly, TimeSpan, Guid, short, int?, TimeZoneInfo?, object)' could not be found using reflection."), false);
      _metadata2 = new InterceptionMetadata(typeof(ISomeInterface).GetMethod("NonVoid10Params", BindingFlags.Public | BindingFlags.Instance, null, new[] { typeof(int), typeof(string), typeof(long), typeof(DateOnly), typeof(TimeSpan), typeof(Guid), typeof(short), typeof(int? ), typeof(TimeZoneInfo), typeof(object) }, null) ?? throw new MissingMethodException("The method 'ISomeInterface.NonVoid10Params(int, string, long, DateOnly, TimeSpan, Guid, short, int?, TimeZoneInfo?, object)' could not be found using reflection."), false);
      _metadata3 = new InterceptionMetadata(typeof(ISomeInterface).GetMethod("Void20Params", BindingFlags.Public | BindingFlags.Instance, null, new[] { typeof(int), typeof(string), typeof(long), typeof(DateOnly), typeof(TimeSpan), typeof(Guid), typeof(short), typeof(int? ), typeof(TimeZoneInfo), typeof(object), typeof(string), typeof(string), typeof(DateTime), typeof(IDisposable), typeof(DateTime), typeof(DateTime), typeof(DateTime), typeof(long? ), typeof(object), typeof(object) }, null) ?? throw new MissingMethodException("The method 'ISomeInterface.Void20Params(int, string, long, DateOnly, TimeSpan, Guid, short, int?, TimeZoneInfo?, object, string?, string, DateTime, IDisposable, DateTime, DateTime, DateTime, long?, object, object)' could not be found using reflection."), false);
      _metadata4 = new InterceptionMetadata(typeof(ISomeInterface).GetMethod("NonVoid20Params", BindingFlags.Public | BindingFlags.Instance, null, new[] { typeof(int), typeof(string), typeof(long), typeof(DateOnly), typeof(TimeSpan), typeof(Guid), typeof(short), typeof(int? ), typeof(TimeZoneInfo), typeof(object), typeof(string), typeof(string), typeof(DateTime), typeof(IDisposable), typeof(DateTime), typeof(DateTime), typeof(DateTime), typeof(long? ), typeof(object), typeof(object) }, null) ?? throw new MissingMethodException("The method 'ISomeInterface.NonVoid20Params(int, string, long, DateOnly, TimeSpan, Guid, short, int?, TimeZoneInfo?, object, string?, string, DateTime, IDisposable, DateTime, DateTime, DateTime, long?, object, object)' could not be found using reflection."), false);
    }
